...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1991522624 1197918807 1774994845 1320867884 7808069280').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001833581722')
...
IMPORT_JK_SITE = environ.get('IMPORT_JK_SITE', 'inshorturl.com')
IMPORT_JK_API = environ.get('IMPORT_JK_API', 'f32e279366f8d1960d32811e1c3fd058db103fc0')
...
VERIFY2_API = environ.get('VERIFY2_API', "f32e279366f8d1960d32811e1c3fd058db103fc0")
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'inshorturl.com')
SHORTLINK_API = environ.get('SHORTLINK_API', 'f32e279366f8d1960d32811e1c3fd058db103fc0')
